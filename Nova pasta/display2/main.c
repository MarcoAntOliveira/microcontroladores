...
int main(void)
{
    ...
    // Habilita o pino 3 do portal F, configura como saida digital
    ...
    while(1)
    {
        EscritaPinosPortal(GPIOPortB_base, Pino_6|Pino_7, 0x00);
        EscritaPinosPortal(GPIOPortD_base, Pino_2|Pino_3, 0x00);
