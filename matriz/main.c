...
void DelayMs (unsigned int ui32DelayMs)
{
    uint32_t ui32Loop, ui32Total;

    ui32Total = ui32DelayMs*10000;

    for(ui32Loop = 0; ui32Loop < ui32Total; ui32Loop++)
            {
            }
...
int main(void)
{
    volatile uint32_t ui32Loop, uint32ContBouncer, uint32VMatriz;
    volatile uint8_t ui8Dig1, ui8Dig2, ui8Dig3, ui8Dig4;
    ...
    ConfiguraPinoSaida (GPIOPortF_base, Pino_4);
    ConfiguraPinoSaida (GPIOPortB_base, Pino_0|Pino_1|Pino_5|Pino_6|Pino_7);
    ConfiguraPinoSaida (GPIOPortC_base, Pino_4|Pino_5|Pino_6|Pino_7);
    ConfiguraPinoSaida (GPIOPortD_base, Pino_2|Pino_3|Pino_6);
    ...
    ConfiguraPinoEntrada (GPIOPortF_base, Pino_0|Pino_1|Pino_2|Pino_3);
    ESC_REG(GPIOPortF_base + GPIO_OS_PDR)|= Pino_0|Pino_1|Pino_2|Pino_3;

    // Loop principal
    while(1)
    {
        //escrita matriz botoes
        EscritaPinosPortal(GPIOPortF_base, Pino_4, 0xFF);
        EscritaPinosPortal(GPIOPortB_base, Pino_0|Pino_1|Pino_5, 0x00);

        uint32VMatriz = LeituraPinosPortal(GPIOPortF_base, Pino_0|Pino_1|Pino_2|Pino_3);
        switch (uint32VMatriz&&0x0F){
            case 0x01:
                ui8Dig1 = sseg_0;
                break;
            case 0x02:
        ...
        EscritaPinosPortal(GPIOPortB_base, Pino_7, 0xFF);
        EscritaPinosPortal(GPIOPortD_base, Pino_2|Pino_3, 0xFF);

        EscritaPinosPortal(GPIOPortC_base, Pino_4|Pino_5|Pino_6|Pino_7, ui8Dig1);
        EscritaPinosPortal(GPIOPortE_base, Pino_0|Pino_1|Pino_2|Pino_3, ui8Dig1);

        for(ui32Loop = 0; ui32Loop < 2000; ui32Loop++)    {        }

        //escrita matriz botoes
        EscritaPinosPortal(GPIOPortF_base, Pino_4, 0x00);
        EscritaPinosPortal(GPIOPortB_base, Pino_0, 0xFF);
        EscritaPinosPortal(GPIOPortB_base, Pino_1|Pino_5, 0x00);

        uint32VMatriz = LeituraPinosPortal(GPIOPortF_base, Pino_0|Pino_1|Pino_2|Pino_3);

        EscritaPinosPortal(GPIOPortB_base, Pino_7, 0x00);
        EscritaPinosPortal(GPIOPortB_base, Pino_6, 0xFF);
        EscritaPinosPortal(GPIOPortD_base, Pino_2|Pino_3, 0xFF);
        ...
        //escrita matriz botoes
        EscritaPinosPortal(GPIOPortF_base, Pino_4, 0x00);
        EscritaPinosPortal(GPIOPortB_base, Pino_1, 0xFF);
        EscritaPinosPortal(GPIOPortB_base, Pino_0|Pino_5, 0x00);

        uint32VMatriz = LeituraPinosPortal(GPIOPortF_base, Pino_0|Pino_1|Pino_2|Pino_3);

        EscritaPinosPortal(GPIOPortB_base, Pino_6|Pino_7, 0xFF);
        EscritaPinosPortal(GPIOPortD_base, Pino_2, 0x00);
        EscritaPinosPortal(GPIOPortD_base, Pino_3, 0xFF);
        ...
        //escrita matriz botoes
        EscritaPinosPortal(GPIOPortF_base, Pino_4, 0x00);
        EscritaPinosPortal(GPIOPortB_base, Pino_5, 0xFF);
        EscritaPinosPortal(GPIOPortB_base, Pino_0|Pino_1, 0x00);

        uint32VMatriz = LeituraPinosPortal(GPIOPortF_base, Pino_0|Pino_1|Pino_2|Pino_3);

        EscritaPinosPortal(GPIOPortB_base, Pino_6|Pino_7, 0xFF);
        EscritaPinosPortal(GPIOPortD_base, Pino_3, 0x00);
        EscritaPinosPortal(GPIOPortD_base, Pino_2, 0xFF);
...
//        if (uint32ContBouncer > 10)
//        {
//            if (LeituraPinosPortal(GPIOPortF_base, Pino_4) == Pino_4)
//                {
//                EscritaPinosPortal(GPIOPortF_base, Pino_3, 0xFF);
//                uint32ContBouncer = 0;
//                }
//            else
//                EscritaPinosPortal(GPIOPortF_base, Pino_3, 0x00);
//        }
//        else
//            uint32ContBouncer++;
