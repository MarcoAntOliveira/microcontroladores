...
int main(void)
{
    ...
    // Habilita o pino 1 do portal F, configura como saída digital
    ESC_REG(GPIO_PORTF_DIR_R) = 0x04;
    ESC_REG(GPIO_PORTF_DEN_R) = 0x04;
    ...
    while(1)
    {
        ...
        {
            ESC_REG(GPIO_PORTF_DATA_R) |= 0x04; // Acende o LED vermelho
        }
        else
        {
            ESC_REG(GPIO_PORTF_DATA_R) &= ~(0x04); // Apaga o LED vermelho
        }
    }
}
